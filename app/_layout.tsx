/**
 * @file _layout.tsx
 * @description Root layout for Scopa. Hydrates theme + locale via
...
console.log('[Scopa/_layout] module loaded');
...
export default function RootLayout() {
  console.log('[Scopa/_layout] RootLayout rendering');
...
/* === End of _layout.tsx — Scopa — SallyCards === */
