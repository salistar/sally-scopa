 ...
 * @description Création d'une room Scopa. Sliders pour maxPlayers (2-10),
...
export default function CreateRoomScreen() {
  ...
  const handleCreate = async () => {
    setCreating(true);
    try {
      log.bin('POST /rooms', { gameType: 'scopa', maxPlayers, isPrivate });
      const room = await api.createRoomFull('scopa', { maxPlayers, isPrivate });
