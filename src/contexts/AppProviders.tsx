...
const DARK: Palette = {
  isDark: true,
  bg: '#0A0A1A',
  bgGradient: ['#0A0A1A', '#052E1F', '#1A2E05'] as const,
  card: 'rgba(26, 22, 50, 0.85)',
  cardGradient: ['#1E1B3A', '#2A1F4D'] as const,
  text: '#F3F4F6',
  textSecondary: '#9CA3AF',
  accent: '#16A34A',
  accentGradient: ['#16A34A', '#84CC16'] as const,
  danger: '#EF4444',
  success: '#10B981',
  gold: '#F59E0B',
  border: 'rgba(255,255,255,0.08)',
  headerGradient: ['#052E1F', '#14532D', '#365314'] as const,
};
...
const K_THEME = '@scopa/theme-mode';
const K_LOCALE = '@scopa/locale';
