/**
 * ScopaEngine - Moteur de jeu Scopa marocain
 ...
 *   est rompue par un "Scopa!" (contestation) ou quand tout le monde passe
 *   sans contester (alors le joueur suivant peut recommencer avec une nouvelle
 *   valeur — cela clôt la séquence précédente).
 * - N'importe quel autre joueur peut crier "Scopa!" pour contester
...
export type GamePhase =
  ...
  | 'challenging'  // Fenêtre de contestation "Scopa!"
...
export function gameReducer(state: GameState, action: GameAction): GameState {
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      // poser une carte (= renoncer à crier Scopa) OU appuyer sur Scopa.
      ...
      // Seule une contestation Scopa! ou un nouveau round peut rompre la
