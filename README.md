...
> Scopa italien — 40 cartes, captures et balais (scope).

[![Build APK](https://github.com/salistar/sally-scopa/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-scopa/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-scopa/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-scopa/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.scopa` |
| **Bundle ID iOS** | `com.sallycards.scopa` |
| **Couleur thème** | `#EA580C` |
...
- Scopa classique + Scopone scientifico (4 joueurs en équipe)
- Multi-joueur en ligne + voice WebRTC
- Bots niveau facile/normal/dur
- Calcul automatique des points (settebello, primiera, scope)
- Cartes italiennes (denari, coppe, bastoni, spade)
- 5 langues
...
```powershell
git clone https://github.com/salistar/sally-scopa.git
cd sally-scopa
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-scopa
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.scopa 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.scopa/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore scopa.keystore -alias scopa `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
SCOPA_UPLOAD_STORE_FILE=scopa.keystore
SCOPA_UPLOAD_KEY_ALIAS=scopa
SCOPA_UPLOAD_STORE_PASSWORD=<password>
SCOPA_UPLOAD_KEY_PASSWORD=<password>
